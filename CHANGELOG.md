...
### Changed
- Added the official project website to the published npm package and MCP Registry metadata.
- Automated MCP Registry publication alongside tagged npm releases using GitHub Actions OIDC.
