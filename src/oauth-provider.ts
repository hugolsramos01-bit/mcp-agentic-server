...
function formHtml(params: {
  ...
  const scopeText = params.scopes.length > 0 ? params.scopes.join(" ") : "agentic";
  const resourceText = params.resource?.href ?? "Agentic MCP endpoint";
...
<html lang="en">
  <head>
    ...
    <title>Connect Agentic MCP</title>
    <style>
...
${hiddenFields}
        ...
        <button type="submit">Authorize Agentic MCP</button>
      </form>
    </main>
  </body>
</html>`;
