...
const root = await mkdtemp(join(tmpdir(), "agentic-apply-patch-"));
...
const outside = await mkdtemp(join(tmpdir(), "agentic-apply-patch-outside-"));
...
const splitHunkRoot = await mkdtemp(join(tmpdir(), "agentic-apply-patch-split-hunk-"));
await writeFile(
...
const trailingSpaceRoot = await mkdtemp(join(tmpdir(), "agentic-apply-patch-trailing-space-"));
...
const overwriteRoot = await mkdtemp(join(tmpdir(), "agentic-apply-patch-overwrite-"));
...
const noNewlineRoot = await mkdtemp(join(tmpdir(), "agentic-apply-patch-newline-"));
...
const eofRoot = await mkdtemp(join(tmpdir(), "agentic-apply-patch-eof-"));
...
const lenientRoot = await mkdtemp(join(tmpdir(), "agentic-apply-patch-lenient-"));
