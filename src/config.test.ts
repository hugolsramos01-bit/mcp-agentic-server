...
assert.match(turboInstructions, /For QUICK changes, prefer direct edit\/write/);
...
assert.doesNotMatch(strictTurboInstructions, /For QUICK changes, prefer direct edit\/write/);
