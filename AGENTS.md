# Agentic MCP — MCP Server Instructions

> **This file describes the MCP server tool itself, not the project you opened.**
> If you opened a workspace to analyze or work on a project, THAT project is your focus — not this server's code.
> Whenever the user mentions another folder, project, or repository, call `open_workspace` again with that path.
...
primitives such as read, edit, write, grep, find, ls, and bash. Agentic MCP wraps
